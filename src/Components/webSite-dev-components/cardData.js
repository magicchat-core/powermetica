const cardData = [
  {
    ...
    svgSrc: "/assets/icons/userExp.svg",
    colorFilter:
      "brightness(0) saturate(100%) invert(99%) sepia(47%) saturate(7339%) hue-rotate(292deg) brightness(90%) contrast(118%);",
    rotate: 0,
  },
  {
    ...
    svgSrc: "/assets/icons/discover_planning.svg",
    colorFilter:
      "brightness(0) saturate(100%) invert(82%) sepia(51%) saturate(1593%) hue-rotate(190deg) brightness(101%) contrast(93%);",
    rotate: 90,
  },
  {
    title: "Quality Assurance & Testing",
    text: "Before your web application goes live, it undergoes rigorous testing to ensure functionality, security, and performance. We fix any issues and ensure your app meets the highest quality standards.",
    svgSrc: "/assets/icons/quality_testing.svg",
    rotate: 200,
    colorFilter:
      "brightness(0) saturate(100%) invert(93%) sepia(62%) saturate(1708%) hue-rotate(309deg) brightness(113%) contrast(103%);",
  },
  {
    ...
    svgSrc: "/assets/icons/development_coding.svg",
    colorFilter:
      "brightness(0) saturate(100%) invert(84%) sepia(50%) saturate(246%) hue-rotate(116deg) brightness(91%) contrast(91%);",
    rotate: 270,
  },
  {
    ...
    svgSrc: "/assets/icons/deployment.svg",
    colorFilter:
      "brightness(0) saturate(100%) invert(71%) sepia(39%) saturate(506%) hue-rotate(339deg) brightness(102%) contrast(101%);",
    rotate: 0,
  },
  {
    ...
    colorFilter:
      "brightness(0) saturate(100%) invert(84%) sepia(97%) saturate(3176%) hue-rotate(165deg) brightness(92%) contrast(96%);",
    rotate: 90,
  },
];
